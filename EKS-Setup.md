...
**N. Virgina: $ eksctl create cluster --name knr-cluster4 --region us-east-1 --node-type t2.medium  --zones us-east-1a,us-east-1b**
	
**Mumbai: $ eksctl create cluster --name knr-cluster4 --region ap-south-1 --node-type t2.medium  --zones ap-south-1a,ap-south-1b**	
...
$ eksctl delete cluster --name knr-cluster4 --region us-east-1
